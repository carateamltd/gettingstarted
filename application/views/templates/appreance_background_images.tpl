  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table_new">
	 <tr>
			...
			<td align="right" id="button_save">
				{foreach from=$lang item=val}{if $val.rLabelName == 'Save Background Settings'}
		    ...
		    <form name="uploadBackgroundIamge" id="uploadBackgroundIamge" method="post" action="{$data.base_url}app/uploadBackgroundIamge">
			 <input type="hidden" value="{$data['iApplicationId']}" name="iAppId">			 
				    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table">
						<tr>
						  <td><label><!--<a class="tooltip_text" href="#"><img src="{$data.base_image}quaton_icon.png" align="absmiddle"/><span><img class="callout_text" src="{$data.base_image}callout.gif" /> 1. Upload an image or select one from below image list.<br> 2. Select tabs, locations, and sliding images by check the checkbox.<br>3. Hit Save Background Settings button to save.</span></a>--></label></td>
						  <td><input type="file" name="file_uploads_btn" id="file_upload_app_image">(100px*143px)
						  </td>
						  <td align="right" width="100">
						  {foreach from=$lang item=val}{if $val.rLabelName == 'Upload an image'}	
						  	<input type="button" value="{$val.rField}" name="upload_btn_icon" class="btn btn_upload_icon" onclick="return uploadAppBgImage();">
						 	{/if}{/foreach}
						  </td>
						  <td align="right" width="100">
						  	{foreach from=$lang item=val}{if $val.rLabelName == 'Select from image library'}
		  ...
		  <div id="background_setting">
		   <form name="saveBackgroundSetting" id="saveBackgroundSetting" method="post" action="{$data.base_url}app/saveBackgroundSetting?iApplicationId={$data['iApplicationId']}">
			 ...
			 <div id="back-mobiles" class="back-mobiles">
					   ...
					   {section name = i loop = $data.your_tabbackground}
						  ...
						  {if $data.your_tabbackground[i]['apptab_deatils']|@count gt 0}	  
							...
							{if $data.your_tabbackground[i]['apptab_deatils'][j]['vTitle'] neq ''}
								{foreach from=$lang item=val}{if $val.rLabelName == $data.your_tabbackground[i]['apptab_deatils'][j]['vTitle']}{$val.rField}{/if}{/foreach}
							</br>
								{else}
								{foreach from=$lang item=val}{if $val.rLabelName == $data.your_tabbackground[i]['apptab_deatils'][j]['default_vTitle']}{$val.rField}{/if}{/foreach}</br>
							   {/if}
						    {/section}
							 </span>						    
						  {/if}
						  ...
						  {else}
						   <span style="color: rgb(255,255,255) !important;">
						   	{foreach from=$lang item=val}{if $val.rLabelName == 'No Background'}
						   		{$val.rField}
						   	{/if}{/foreach}
						   </span>
						  {/if}
			  ...
			  <div class="button_1">
					   <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table buttons_tbl">
						    ...
						    {foreach from=$lang item=val}{if $val.rLabelName == 'Choose which sections'}
						   		{$val.rField}
						   	{/if}{/foreach}:</label></td>
						    <td><!--<label>
								...
								<div class="skin skin-line-mobile">
									  <ul class="list tabs_checked">
										<li>
										  ...
										  <label for="selectAll">{foreach from=$lang item=val}{if $val.rLabelName == 'Select all'}{$val.rField}{/if}{/foreach}</label>
										</li>
									  </ul>
								  </div>
						    </td>
			  ...
			  <div class="button_row1">
				  ...
				  <div class="label">{foreach from=$lang item=val}{if $val.rLabelName == 'Tabs'}{$val.rField}{/if}{/foreach}</div>				  
			...
			<div class="button_1">
				      <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table buttons_tbl">
						  <tr>
						  <td><label class="spec_label">{foreach from=$lang item=val}{if $val.rLabelName == 'have backgrounds'}{$val.rField}{/if}{/foreach} :</label></td>
						  </tr>
				      </table>
			</div>
		     </div>		    
			...
			<form name="saveBackgroundSetting" id="saveBackgroundSetting" method="post" action="{$data.base_url}app/saveBackgroundSetting?iApplicationId={$data['iApplicationId']}">
			 ...
			 <div id="back-mobiles" class="back-mobiles">
				  <div class="stock_section">			  		
					  <ul>
					   ...
					   {section name = i loop = $data.your_tabbackground}
						  ...
						  {/section}
						  {else}
						   <span style="color: rgb(255,255,255) !important;">{foreach from=$lang item=val}{if $val.rLabelName == 'No Background'}
						   		{$val.rField}
						   	{/if}{/foreach}</span>
						  {/if}
					  </ul>
			  ...
			  <div class="button_1">
					   <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table buttons_tbl">
						    <tr>
						    <td><label class="spec_label">{foreach from=$lang item=val}{if $val.rLabelName == 'No Background'}
						   		{$val.rField}
						   	{/if}{/foreach}</label></td>
						    <td><!--<label>
						    <input type="checkbox" id="selectAll" name="Select_All" class="onbtn" value="1" onclick="return check_all();"> Select all </label>-->
								<div class="skin skin-line-iphone">
								  <ul class="list tabs_checked">
									<li>
									  ...
									  <label for="selectAll_iPhone_tab">{foreach from=$lang item=val}
					   ...
					   {section name = i loop = $data.iPad_tabbackground}
						  ...
						  {/if}
							  ...
							  <div class="links_bottoms">
								  ...
								  <a href="javascript:void(0);" ><span class="btn_bg btn_bg_delete" onclick="return deleteAppImage('{$data.iPad_tabbackground[i].iBackgroundId}','back_ipads');"></span></a>
					 ...
					 <div class="skin skin-line-ipad">
							  <ul class="list tabs_checked">
								<li>								  
								  ...
								  <label for="tabId">{foreach from=$lang item=val}{if $val.rLabelName == $data.selected_feature_details[i].vTitle}
						   		{$val.rField}
						   	{/if}{/foreach}</label>
								</li>
								<!--<li>
