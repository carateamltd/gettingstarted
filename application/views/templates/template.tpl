...
<head>
   ...
   <link href="{$data.base_font_awsome}css/font-awesome.min.css" rel="stylesheet" />
   <link href="{$data.base_css}style-responsive.css" rel="stylesheet" />
   <link href="{$data.base_css}style.navyblue.css" rel="stylesheet" id="style_color" />
   <link href="{$data.base_css}themestyle.css" rel="stylesheet" id="style_color" />
   ...
   <link href="{$data.base_assets}bootstrap-colorpicker/css/colorpicker.css" rel="stylesheet" type="text/css" media="screen"/>
    ...
    <script type="text/javascript" src="{$data.base_assets}js/jquery.slimscroll.js"></script>
...
<script src="{$data.base_js}qrcode.js"></script>
