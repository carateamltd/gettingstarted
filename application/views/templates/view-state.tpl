<script type="text/javascript" src="{$data.basedatatable_js}state_listing.js"></script>
    ...
    <div class="row-fluid">
        ...
        <!-- BEGIN EXAMPLE TABLE widget-->
            ...
            <div class="widget-title">
                <h4><i class="icon-reorder"></i> State Master</h4>
                <span class="tools">
            ...
            <div class="space15">
                    ...
                    <a href="{$admin_url}state/create" class="btn green">Add New <i class="icon-plus"></i></a>
                    <button type="submit" id="btn-delete" class="btn green">Delete</button>
                    </div>
                </div>
   			<table class="table table-striped table-bordered" id="StatelistId" border="0" cellpadding="0" cellspacing="0" width="100%">
                <thead>
                    <tr>
