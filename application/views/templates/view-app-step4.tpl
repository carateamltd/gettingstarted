	 ...
	 <div class="widget-body">
	 	...
	 	<div class="mainpartcont">
	 		...
	 		<div class="tbdata">
	 			<div class="progress progress-striped active" >
		     		...
		     		<div class="midmainwrap">
		     			<ul>
		     				<li><a href="#maintabs-appearance">{foreach from=$lang item=val}
		     						{if $val.rLabelName == 'Appearance'}{$val.rField}{/if}
		     						{/foreach}
		     					</a>
		     				</li>
			   		<li><a href="#background_images">{foreach from=$lang item=val}
		     						{if $val.rLabelName == 'Background Image'}{$val.rField}{/if}
		     						{/foreach}
		     					</a>
		     				</li>
			   		<li><a href="#maintabs-applayout">{foreach from=$lang item=val}
		     						{if $val.rLabelName == 'App Layout'}{$val.rField}{/if}
		     						{/foreach}
		     					</a>
		     				</li>
					</ul>
			...
			<div class="tab_main_title">
				 ...
				 <tr>
				    <td width="350" align="left" style="padding-left: 20px;">
      				    <h2>{foreach from=$lang item=val}{if $val.rLabelName == 'Premium Design'}{$val.rField}{/if}{/foreach}</h2>
				    </td>
				    <td width="300">
				    ...
				    <td align="right">
				    	{foreach from=$lang item=val}{if $val.rLabelName == 'SaveItem'}
			   ...
			   <div style="float:left; width:100%;">
				 ...
				 <div>
				    <div class="button_1" id="buttonsDiv">
					  ...
					  {foreach from=$lang item=val}{if $val.rLabelName == 'Direction Button'}{$val.rField}{/if}{/foreach}</label>
					  </td>
					  <td><label>
					  ...
					  {foreach from=$lang item=val}{if $val.rLabelName == 'Tell Friend Button'}{$val.rField}{/if}{/foreach}</label></td>
					  </tr>
				       </table>
				    </div>
				    ...
				    <div class="button_1">
				       <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table buttons_tbl">
					  <tr>
					  <td width="29%"><label class="spec_label" style="cursor:default;">{foreach from=$lang item=val}{if $val.rLabelName == 'Show Status Bar'}{$val.rField}{/if}{/foreach}:</label></td>
					  <td><label>
				    ...
				    <div class="button_1">
					  ...
					  <tr>
                        ...
                        <label class="margin_5ptop">
						   <input type="radio" value="bottom" class="onbtn_radi"  name="radio_layout" id="layoutbot" {$bottomcheck} onClick="change_layout('footer_tab');"/>{foreach from=$lang item=val}{if $val.rLabelName == 'Bottom'}{$val.rField}{/if}{/foreach}
	        				</label></label>
	        			</center>
					     </td>
					     <td>
				    ...
				    <div class="button_1">
				       <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table buttons_tbl">
					  <tr>
					  <td width="29%"><label class="spec_label" style="cursor:default;">{foreach from=$lang item=val}{if $val.rLabelName == 'More Button Navigation?'}{$val.rField}{/if}{/foreach}</label></td>
					  <td><label>
			   ...
			   <div id="appr-buttons" class="appr-buttons levelborder">
			      <ul class="innertabbtn">
				 <li class="innertabbtncklik"><a class="btn" href="#appr-buttons-tabbackg">{foreach from=$lang item=val}{if $val.rLabelName == 'Tab Background'}{$val.rField}{/if}{/foreach}</a></li>
				 <li class="inactivebtntab"><a class="btn" href="#appr-buttons-icolor">{foreach from=$lang item=val}{if $val.rLabelName == 'Tab Background Icon Color'}{$val.rField}{/if}{/foreach}</a></li>
				 <li class="inactivebtntab"><a class="btn" href="#appr-buttons-tabcol">{foreach from=$lang item=val}{if $val.rLabelName == 'Tab Color'}{$val.rField}{/if}{/foreach}</a></li>
				 <li class="inactivebtntab"><a class="btn" href="#appr-buttons-tabtext">
				 {foreach from=$lang item=val}{if $val.rLabelName == 'Tab Text'}{$val.rField}{/if}{/foreach}</a></li>
			      </ul>
				  ...
				  <div class="button_1" id="addpdf_validation">
				    <form name="buuton_upload" id="buuton_upload" method="post" action="{$data.base_url}app/upload_button_img" enctype="multipart/form-data">
					   ...
					   <tr>
						...
						<td>
							{foreach from=$lang item=val}{if $val.rLabelName == 'Upload'}
				 ...
				 {foreach from=$lang item=val}
				 {if $val.rLabelName == 'Tab Color'}{$val.rField}
				 {/if}
				{/foreach}
				 ...
				 <div class="button_1">
				    ...
				    <tr>
				    <td><label>
				    <input type="checkbox" value="1" class="onbtn_radi"  name="checkbox7" />{foreach from=$lang item=val}
				 {if $val.rLabelName == 'Show the Menu Text'}{$val.rField}
				 {/if}
				{/foreach}</label>
			   ...
			   <div id="appr-header" class="appr-header levelborder">
			      <ul class="innertabbtn">
				 <li class="innertabbtncklik"><a class="btn" href="#appr-header-lh" id="launch_header">{foreach from=$lang item=val}{if $val.rLabelName == 'Launch Header'}{$val.rField}{/if}{/foreach}</a></li>
				 <li class="inactivebtntab"><a class="btn" href="#appr-header-lt" id="launcher_tint" >{foreach from=$lang item=val}{if $val.rLabelName == 'Launcher Tint'}{$val.rField}{/if}{/foreach}</a></li>
				 <li class="inactivebtntab"><a class="btn" href="#appr-header-gh" id="global_header">Global Header</a></li>
				 <li class="inactivebtntab"><a class="btn" href="#appr-header-gt" id="global_tint">{foreach from=$lang item=val}{if $val.rLabelName == 'Global Tint'}{$val.rField}{/if}{/foreach}Global Tint</a></li>
			      </ul>
				 ...
				 <div class="button_1">
				  <form name="header_imgupload" id="header_imgupload" method="post" action="{$data.base_url}app/upload_header_img" enctype="multipart/form-data">
					 <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table buttons_tbl_right">
					   <tr>
						<td class="btnbrowse btnhelp"><label><!--<a class="tooltip_text" href="javascript:void(0);"><img src="{$data.base_image}quaton_icon.png" align="absmiddle"/> <span><img class="callout_text" src="{$data.base_image}callout.gif" /> {foreach from=$lang item=val}{if $val.rLabelName == 'Upload image action will also save your current settings'}{$val.rField}{/if}{/foreach}</span></a>--></label></td>
						<td class="btnbrowse">
			...
			<div id="appr-colors" class="appr-colors levelborder">
			   <ul class="innertabbtn">
			      <li class="innertabbtncklik"><a class="btn" href="#appr-colors-gac"> {foreach from=$lang item=val}
			   ...
			   <div id="appr-colors-gac">
				 ...
				 <td><select  name="select" onChange="chng_color_theme(this.value);">
				   <option value="">{foreach from=$lang item=val}
						 ...
						 {/if}
					       {/foreach}</option>
				   <option value="0">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Aquatic Blue'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="1">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Beach Blue'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="2">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Bear Brown'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="3">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Carrot Orange'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="4">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Dark Rose'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="5">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Dazzling Red'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="6">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Forest Green'}
						 {$val.rField}
						 {/if}
					       {/foreach}</option>
				   <option value="7">{foreach from=$lang item=val}
				 ...
				 <tr>
					...
					<table width="80%" >
					<tr><td width="60%" style="text-align:right;"><span class="lbl_color">{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Bar'}
						 {$val.rField}
						 {/if}
					       {/foreach}:</span></td><td><input type="text"  value="{$data.allappdesignInfo[0].vNavigationBar}" id="navigation_bar" data-color-format="rgb" class="cp2 color_text_hide" style="width:25px !important;background:{$data.allappdesignInfo[0].vNavigationBar};color:{$data.allappdesignInfo[0].vNavigationBar};" /></td>
					<td><span>{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Text'}
						 {$val.rField}
						 {/if}
					       {/foreach}:</span></td><td><input type="text"  value="{$data.allappdesignInfo[0].vNavigationText}" id="navigation_text" data-color-format="rgb" class="cp2 color_text_hide" style="width:25px !important;background:{$data.allappdesignInfo[0].vNavigationText};color:{$data.allappdesignInfo[0].vNavigationText};"></td>
</tr>
					</table>
					</td>
				 </tr>
					 ...
					 <td class="withsepaline">
					  <table width="80%">
						<tr><td width="60%" style="text-align:right;"><span>{foreach from=$lang item=val}
						 ...
						 {$val.rField}
						 {/if}
					       {/foreach}:</span></td><td><input type="text"  value="{$data.allappdesignInfo[0].vSectionBar}" id="section_bars" data-color-format="rgb" class="cp2 color_text_hide" style="width:25px !important; background:{$data.allappdesignInfo[0].vSectionBar};color:{$data.allappdesignInfo[0].vSectionBar};" /></td>
						<td><span>{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Text'}
						 {$val.rField}
						 {/if}
					       {/foreach}: </span></td><td><input type="text"  value="{$data.allappdesignInfo[0].vSectionText}" id="section_text" data-color-format="rgb" class="cp2 color_text_hide" style="width:25px !important; background:{$data.allappdesignInfo[0].vSectionText};color:{$data.allappdesignInfo[0].vSectionText};" /> </td>
					  </table>
				...
				<table width="80%" >
					<tr><td width="60%" style="text-align:right;"><span>{foreach from=$lang item=val}
						 ...
						 {$val.rField}
						 {/if}
					       {/foreach}: </span></td><td><input type="text"  value="{$data.allappdesignInfo[0].vOddRowBar}" id="oddRow_bar" data-color-format="rgb" class="cp2 color_text_hide" style="width:25px !important; background:{$data.allappdesignInfo[0].vOddRowBar};color:{$data.allappdesignInfo[0].vOddRowBar};" /></td>
					<td><span>{foreach from=$lang item=val}
						 {if $val.rLabelName == 'Text'}
						 {$val.rField}
						 {/if}
					       {/foreach}: </span></td><td><input type="text"  value="{$data.allappdesignInfo[0].vOddRowText}" id="oddRow_text" data-color-format="rgb" class="cp2 color_text_hide" style="width:25px !important; background:{$data.allappdesignInfo[0].vOddRowText};color:{$data.allappdesignInfo[0].vOddRowText};" /></td>
					</tr>
				</table>
