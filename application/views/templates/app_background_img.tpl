<div id="app_bgimage_gallaery" class="modal show fade">
 <div class="modal-header">
	...
	<h3 id="Select_image">Background Information</h3>
 </div>
 <div class="modal-body">
   <form name="save_app_feature" id="saveAppImage" action="{$data.base_url}app/saveAppImage" method="POST">
	...
	<input type="hidden" name="app_type" value="Mobile" id="bg_img_type"/>
 ...
 <div class="modal-footer">
     <button type="button" class="btn btn-primary" id="saveAppImage" onclick="return saveAppImage();" >Save</button>
