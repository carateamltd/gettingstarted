<script type="text/javascript" src="{$data.basedatatable_js}role_listing.js"></script>
			...
			<div class="span12">
				...
				<div class="widget purple">
					<div class="widget-title">
						<h4><i class="icon-reorder"></i> Role</h4>
						<span class="tools">
					...
					<div class="widget-body">
						...
						<div class="space15">
                            <div class="pull-right">
			                    ...
			                    <a href="{$admin_url}role/create" class="btn green">Add New <i class="icon-plus"></i></a>
			                    <button type="submit" id="btn-delete" class="btn green">Delete</button>
			                </div>
              			</div>
						<table class="table table-striped table-bordered" id="RolelistingId" border="0" cellpadding="0" cellspacing="0" width="100%">
						<thead>
						<tr>
