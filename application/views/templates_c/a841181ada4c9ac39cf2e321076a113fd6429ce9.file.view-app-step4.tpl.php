<?php /* Smarty version Smarty-3.1.11, created on 2015-08-06 18:00:29
         compiled from "application\views\templates\view-app-step4.tpl" */ ?>
<?php /*%%SmartyHeaderCode:32101559d4098f37006-09296153%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a841181ada4c9ac39cf2e321076a113fd6429ce9' => 
    array (
      0 => 'application\\views\\templates\\view-app-step4.tpl',
      1 => 1438780992,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32101559d4098f37006-09296153',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_559d409b4ab042_35105920',
  'variables' => 
  array (
    'data' => 0,
    'lang' => 0,
...
<?php if ($_valid && !is_callable('content_559d409b4ab042_35105920')) {function content_559d409b4ab042_35105920($_smarty_tpl) {?>
	 		...
	 		<div class="tbdata">
	 			<div class="progress progress-striped active" >
		     		...
		     		<div class="midmainwrap">
		     			<ul>
		     				<li><a href="#maintabs-appearance"><?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lang']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?>
		     						<?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Appearance'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?>
		     						<?php } ?>
		     					</a>
		     				</li>
			   		<li><a href="#background_images"><?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lang']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?>
...
<?php }?>
			   		...
			   		<li><a href="#maintabs-applayout"><?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lang']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Premium Design'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?><?php } ?></h2>
				    </td>
				    <td width="300">
...
<?php }?><?php } ?></a></li>
				 ...
				 <div>
				    <div class="button_1" id="buttonsDiv">
					  ...
					  <tr>
					  <td><label class="spec_label" style="cursor:default;"><?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lang']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Buttons'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Call Button'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?><?php } ?>
					 </label>
					  </td>
					  <td><label>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Direction Button'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?><?php } ?></label>
					  </td>
					  <td><label>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Tell Friend Button'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?><?php } ?></label></td>
					  </tr>
				       </table>
				    </div>
...
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Show Status Bar'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?><?php } ?>:</label></td>
					  <td><label>
					  <input type="checkbox"  class="onbtn"  name="eShowStatusBar" id="eShowStatusBar" <?php if ($_smarty_tpl->tpl_vars['data']->value['allappdesignInfo'][0]['eShowStatusBar']=="Yes"){?> checked="ckecked" <?php }?> />&nbsp;</label>
					  </td>
					  </tr>
				       </table>
				    </div>
...
app_layout_bottom.png" alt="SLB" />
 ...
 onClick="change_layout('footer_tab');"/><?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['lang']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value){
$_smarty_tpl->tpl_vars['val']->_loop = true;
?><?php if ($_smarty_tpl->tpl_vars['val']->value['rLabelName']=='Bottom'){?><?php echo $_smarty_tpl->tpl_vars['val']->value['rField'];?>
<?php }?><?php } ?>
	        				</label></label>
	        			</center>
					     </td>
