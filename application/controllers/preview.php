...
class Preview extends MY_Controller
{
    ...
    function index()
    {
        ...
        */ 
        ...
        foreach($activeTabs AS $key=>$val){
            if($iconcolorId[0]['iIconcolorId'] != ''){
                ...
                if($activeTabs[$key]['vImage'] !=''){
                    /*$activeTabs[$key]['vImage'] = $this->data['base_upload']."tab_icon/".$activeTabs[$key]['iIconcolorId']."/".$activeTabs[$key]['vImage'];   */ 
					$activeTabs[$key]['vImage'] = "images/tab_icon/".$activeTabs[$key]['iIconcolorId']."/".$activeTabs[$key]['vImage'];    
                }    
            }else{
                if($activeTabs[$key]['vImage'] !=''){
                   /* $activeTabs[$key]['vImage'] = $this->data['base_upload']."tab_icon/".$activeTabs[$key]['iIconcolorId']."/".$activeTabs[$key]['vImage']; */
         ...
         foreach($activeTabs AS $key=>$val){            
           ...
           /* echo "<pre>";
				print_r($val['iApplicationId']);
				print_r($val['iAppTabId']);
				print_r($tabwisemainbackgroundimage);
				print_r($activeTabs);
			echo "</pre>";
			exit;*/
            if($tabwisemainbackgroundimage){
                foreach($tabwisemainbackgroundimage as $bgkey=>$backimage){
                    ...
                    if($backimage['iAppTabId'] == $activeTabs[$key]['iAppTabId']){
                        ...
                        */
						/* echo "<pre>";
							print_r($backgroundimageArr[$key]['mobileimage']);
						   exit;*/
					 ...
					 $this->data['appdata']['back_bg_image'] = $backgroundimageArr[$key]['mobileimage'];
                }
            }else{
                $backgroundimageArr[$key]['tabletimage'] = '';
                $activeTabs[$key]['tabletimage'] = '';
      ...
      $defpageback = $this->preview_model->getdeafaultbackground($iApplicationId);
        ...
        $script_file = $dest.'/javascripts/script.js';
		  $app_script_file = $dest.'/app/helper/AppConstant.js';
    ...
    **/  
    ...
    function createPages()
	{
		...
		$back_bg_image = $this->data['appdata']['back_bg_image']; 
        ...
        **/
        ...
        $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                        ...
                        if($this->data['appdata']['appOtherInfo'][0]['iGlobalHeaderId']!=0)
                        {
                            $html_last.='<h1 class="hedbglunch"><span class="hdspage"  id="itemdetailtitle">&nbsp;</span></h1>
                            <div class="bgcolor_hedlunch">&nbsp;</div>';
                        }
                        else
                        {
                    ...
                    $html_last.= '</div>
                    <div style="clear:both;"></div>
                    <div data-role="content" class="fixheight">
        ...
        **/
        ...
        $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                        ...
                        if($this->data['appdata']['appOtherInfo'][0]['iGlobalHeaderId']!=0)
                        {
                            $html_last.='<h1 class="hedbglunch"><span class="hdspage"  id="qrcodetitle">&nbsp;</span></h1>
                            <div class="bgcolor_hedlunch">&nbsp;</div>';
                        }
                        else
                        {
                            $html_last.='<h1><span class="hdspage" id="qrcodetitle">&nbsp;</span></h1>
                            <div>&nbsp;</div>';
                        }
        ...
        **/
        ...
        $html_last.= '<div data-role="page" id="ordershow_detail_main">';
                $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                                ...
                                if($this->data['appdata']['appOtherInfo'][0]['iGlobalHeaderId']!=0)
                                {
                                    $html_last.='<h1 class="hedbglunch"><span class="hdspage"  id="orderdetailtitle">&nbsp;</span></h1>
                                    <div class="bgcolor_hedlunch">&nbsp;</div>';
                                }
                                else
                                {
		...
		// receipt details
		$html_last.= '<div data-role="page" id="receipt_detail_main">';
                $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                                <a href="/" data-role="button" data-rel="back">Back</a>';
                            ...
                            $html_last.= '</div>
								<div style="clear:both;"></div>
								<div data-role="content">
									<div id="receipt_detail" class="midpartwrap">
										&nbsp;   
									</div>
								</div>';
                            $html_last.= $this->createFooter();
        ...
        $html_last.= '<div data-role="page" id="loyalty_detail_main_show">';
			...
			$html_last.= '<div data-role="page" id="reservation_thanks">';
            $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                            <a href="/" data-role="button" data-rel="back">Back</a>';
            ...
            $html_last.= '</div>
                        ...
                        $html_last.= '<div id="midpartwrap">';
                            $html_last.= '<div class="detail_part">';
                                $html_last.= '<div class="thankscl">';
                                    $html_last.= '<p>Your Reservation has successfully Done.</p>';
                                $html_last.= '</div>';
                            $html_last.= '</div>
                                    </div>
                        </div>';
...
//Reservation Datepicker Starts
    ...
    $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                      <a href="/" data-role="button" data-rel="back">Back</a>';
                        ...
                        <div data-role="content">
                                ...
                                <input type="text" class="date-input" id="date" data-inline="false" data-role="date" value="'.$new_date.'">
                                	<fieldset data-role="controlgroup" data-type="horizontal" id="controlgroup">
                                    </fieldset>
                                    <select class="" id="event_day_time">
                                    </select>
                                <center><a href="javascript:book_details()" class="btn btn-primary ui-link">Book It</a></center>
                            </div>
                        </div>';
                        $html_last.= $this->createFooter();
                    $html_last.= '</div>'."\n\n";
	...
	//Reservation Variables Starts
        $html_last.= '<input type="hidden" name="iApplicationId_book" id="iApplicationId_book" value="" >
				  <input type="hidden" name="iLocationId_book" id="iLocationId_book" value="" >
                                    ...
                                    <table style="width:100%;" cellspacing="10" cellpadding="10">
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <a href="javascript:book_service_confirm()" class="btn btn-primary" style="background-color: white; border-color: white; color: #000000 !important; font-weight: 500;">Confirm</a>
                                                </center>
                                            </td>
                                        </tr>
                                    </table>
...
//Reservation Service Forgot Password Ends 
            ...
            $html_last.= '<div data-role="header" id="hedbg" class="headerbg hbgglobal">
                    ...
                    if($this->data['appdata']['appOtherInfo'][0]['iGlobalHeaderId'] != 0)
                    {
                        $html_last.='<h1 class="hedbglunch">Around Us</h1>
                        <div class="bgcolor_hedlunch">&nbsp;</div>';
                    }
                    else
                    {
                        $html_last.='<h1>Around Us</h1>
                        <div>&nbsp;</div>';
                    }
          ...
          // End Mayur Gajjar
                ...
                $SCRIPTbody .= 'var isvalid = emailReg.test(vEmail);'."\n";
                $SCRIPTbody .= 'if(vMailName==""){'."\n";
                $SCRIPTbody .= '$("#msg").html("Please enter name");'."\n";
                $SCRIPTbody .= '$("#mailing_validation").show();'."\n";
                $SCRIPTbody .= '$("#vMailName").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'else{'."\n";
                $SCRIPTbody .= '$("#mailing_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'if(vEmail==""){'."\n";

                $SCRIPTbody .= '$("#msg").html("Please enter email");'."\n";
                $SCRIPTbody .= '$("#mailing_validation").show();'."\n";
                $SCRIPTbody .= '$("#vMail").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'else{'."\n";
                $SCRIPTbody .= '$("#mailing_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'if(isvalid== false){'."\n";
                $SCRIPTbody .= '$("#msg").html("Please Enter Valid Email");'."\n";
                $SCRIPTbody .= '$("#mailing_validation").show();'."\n";
                $SCRIPTbody .= '$("#vMail").focus();'."\n";
                ...
                $SCRIPTbody .= 'var isvalid = emailReg.test(vEmail);'."\n";
                $SCRIPTbody .= 'var regex = /^[\d\s\(\)\-]+$/g;'."\n";
                 $SCRIPTbody .= 'var isvalidnumber = regex.test(vContactNumber);'."\n";
                
                $SCRIPTbody .= 'if(vName==""){'."\n";
                $SCRIPTbody .= '$("#msgcontact").html("Please enter Name.");'."\n";
                $SCRIPTbody .= '$("#contactus_validation").show();'."\n";
                $SCRIPTbody .= '$("#vName").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'else{'."\n";
                $SCRIPTbody .= '$("#contactus_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                 $SCRIPTbody .= 'if(vEmail==""){'."\n";
                $SCRIPTbody .= '$("#msgcontact").html("Please enter email.");'."\n";
                $SCRIPTbody .= '$("#contactus_validation").show();'."\n";
                $SCRIPTbody .= '$("#vEmail").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'else{'."\n";
                $SCRIPTbody .= '$("#contactus_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'if(isvalid== false){'."\n";
                $SCRIPTbody .= '$("#msgcontact").html("Please Enter Valid Email.");'."\n";
                $SCRIPTbody .= '$("#contactus_validation").show();'."\n";
                $SCRIPTbody .= '$("#vEmail").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                ...
                $SCRIPTbody .= '$("#contactus_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'if(vContactNumber == ""){'."\n";
                $SCRIPTbody .= '$("#msgcontact").html("Please Enter Number.");'."\n";
                $SCRIPTbody .= '$("#contactus_validation").show();'."\n";
                $SCRIPTbody .= '$("#vContactNumber").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'else{'."\n";
                $SCRIPTbody .= '$("#contactus_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'if(isvalidnumber== false){'."\n";
                $SCRIPTbody .= '$("#msgcontact").html("Please Enter Valid Number.");'."\n";
                $SCRIPTbody .= '$("#contactus_validation").show();'."\n";
                $SCRIPTbody .= '$("#vContactNumber").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                ...
                $SCRIPTbody .= '$("#contactus_validation").hide();'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'if(tMessage ==""){'."\n";
                $SCRIPTbody .= '$("#msgcontact").html("Please Enter message.");'."\n";
                $SCRIPTbody .= '$("#contactus_validation").show();'."\n";
                $SCRIPTbody .= '$("#tMessage").focus();'."\n";
                $SCRIPTbody .= 'return false;'."\n";
                $SCRIPTbody .= '}'."\n";
                $SCRIPTbody .= 'else{'."\n";
                $SCRIPTbody .= '$("#contactus_validation").hide();'."\n";
               ...
               /* $SCRIPTbody .= 'else if (!emailReg.test($("#vMail").val())) {'."\n";
                ...
                /** ========= Order details =========== **/
                $url_contact = $this->data['base_url']."webservice?action=book_service_confirm";  
                if($appOtherInfo['defbackgroundimage']!='')
                {
                    if($this->data['appdata']['appOtherInfo'][0]['iLunchheaderId']!=0)
                    {
                ...
                $SCRIPTbody .= 'function book_service_confirm(){'."\n";
                $SCRIPTbody .= 'var iApplicationId = $("#iApplicationId_book").val();'."\n";
				$SCRIPTbody .= 'var iUserId = 1;'."\n";
				$SCRIPTbody .= 'var iLocationId = $("#iLocationId_book").val();'."\n";
				$SCRIPTbody .= 'var iServiceId = $("#iServiceId_book").val();'."\n";
                $SCRIPTbody .= 'var iServiceId_book = $("#iServiceId_book").val();'."\n";
                $SCRIPTbody .= 'var vServicePrice = $("#vServicePrice_curr").val();'."\n";
                $SCRIPTbody .= 'var vServiceFees = $("#vServiceReservationFees_curr").val();'."\n";
                $SCRIPTbody .= 'var vDate = $("#date").val();'."\n";
                $SCRIPTbody .= 'var vTime = $("#event_day_time").val();'."\n";
                
                $SCRIPTbody .= '$.ajax({'."\n";
                    $SCRIPTbody .= 'url: "'.$url_contact.'",'."\n";
                    $SCRIPTbody .= 'type: "GET",'."\n";
					$SCRIPTbody .= 'dataType: "jsonp",'."\n";
                    $SCRIPTbody .= 'data: "iApplicationId=" + iApplicationId + "&iUserId=" + iUserId + "&iLocationId="+iLocationId+"&iServiceId="+iServiceId+"&vServicePrice="+vServicePrice+"&vServiceFees="+vServiceFees+"&vDate="+vDate+"&vTime="+vTime,'."\n";
                    $SCRIPTbody .= 'success: function (result)'."\n"; 
                    $SCRIPTbody .= '{'."\n";
                    	$SCRIPTbody .= '$.mobile.changePage("#reservation_thanks");'."\n";
                    $SCRIPTbody .= '}'."\n";
			    $SCRIPTbody .= '});'."\n";
                $SCRIPTbody .= '}'."\n";
                /* ========= End order details ============*/
                ...
                $SCRIPTbody .= 'var mylink = "http://www.easyapps.fr/";'."\n";
                $SCRIPTbody .= 'var message = "I have been using this WebApp. Please check it out at";'."\n";
                $SCRIPTbody .= 'var redir_url = "http://www.easyapps.fr/";'."\n";
                $SCRIPTbody .= 'var ContestImage = "http://www.easyapps.fr/assets/images/logo.png";'."\n";
                ...
                $SCRIPTbody .= 'var shareurl = "http://www.easyapps.fr/";'."\n";
...
//                $SCRIPTbody .= '}'."\n";
				...
				$SCRIPTbody .= 'title="Qr Code"'."\n";
				$SCRIPTbody .= '$("#qrcodetitle").html(title);'."\n";
                ...
                $lang= $this->session->userdata('language');
                $mylang = $this->admin_model->get_language_details($lang);

                $iAdminId = $this->data['user_info']['iAdminId'];
                
                /** Preview Model **/
        		$tabs = $this->preview_model->get_total_show_tabs($iApplicationId, $mylang, $iAdminId);

            	/** script main view **/
        		$script_main_view = '';
        		$script_main_view .= $tabs;
        		
        		$dest_t = $this->data['base_download_path']."www-".$iApplicationId;
        		$app_script_main_file = $dest_t.'/app/view/MainView.js';
        		
        		$handys = fopen($app_script_main_file, 'w') or die('Cannot open file:  '.$app_script_main_file);
        		fwrite($handys, $script_main_view);
        		fclose($handys);
        		/** End Of Preview **/


                /** style.css for sencha touch **/
                $base_upload = $this->data['base_upload'];
                $iApplicationId  =  $this->data['iApplicationId'];
                $mystyle = $this->preview_model->get_style_sheet_sencha($iApplicationId,$base_upload);    

                /*echo "<pre>";
                    print_r($mystyle);
                exit;*/ 

                $sencha_stylesheet = $this->data['base_download_path']."www-".$iApplicationId;
                $app_script_style_file = $sencha_stylesheet.'/css/style.css';


                $handys_style = fopen($app_script_style_file, 'w') or die('Cannot open file:  '.$app_script_style_file);
                fwrite($handys_style, $mystyle);
                fclose($handys_style);
                /** End Style css **/
        		...
        		/** AppConstant for sencha touch **/
        		$SCRIPTAPPbody = '';
        		$SCRIPTAPPbody .= 'TextConstants = {'."\n";
        		$SCRIPTAPPbody .= 'ApplicationId:'.$iApplicationId.','."\n";
        	//	$SCRIPTAPPbody .= 'AppTabId:'.$AppTabId.','."\n";
        		$SCRIPTAPPbody .= 'UserId:0,'."\n";
        		$SCRIPTAPPbody .= 'INDEX:0,'."\n";
        		$SCRIPTAPPbody .= 'DeviceToken:0,'."\n";
                $SCRIPTAPPbody .= 'DeviceId:0,'."\n";
                $SCRIPTAPPbody .= 'DeviceName:0,'."\n";
                $SCRIPTAPPbody .= 'MESSAGE:"Message",'."\n";
        		$SCRIPTAPPbody .= 'Error:"Error",'."\n";
                /*if($lang == 'rFrench'){
                    $SCRIPTAPPbody .= 'Sorry:"Salut!",'."\n";
                }else if($lang == 'rEnglish'){
                    $SCRIPTAPPbody .= 'Sorry:"Welcome",'."\n";
                } */
        		/*if($lang == 'rEnglish'){
                    $SCRIPTAPPbody .= 'NetWork_Problem:"Please Check your network connectivity"'."\n";
                }else if($lang == 'rFrench'){
                    $SCRIPTAPPbody .= 'NetWork_Problem:"Veuillez verifier votre Connexion internet svp."'."\n";
                }*/
        		$SCRIPTAPPbody .= '}'."\n";
        		
        		$SCRIPTAPPbody .= 'URLConstants = {'."\n";
        		$SCRIPTAPPbody .= 'URL:"'.$this->data['base_url'].'webservice?",'."\n";
        		$SCRIPTAPPbody .= 'Loyality_Image:"'.$this->data['base_url'].'uploads/Loyalty/",'."\n";
        		$SCRIPTAPPbody .= 'Order_Item_Image:"'.$this->data['base_url'].'uploads/Item/",'."\n";
        		$SCRIPTAPPbody .= 'GoogleApi:"https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=5&q="'."\n";
        		$SCRIPTAPPbody .= '}';
        		
        		$dest = $this->data['base_download_path']."www-".$iApplicationId;
        		$app_script_file = $dest.'/app/helper/AppConstant.js';
        		$handy = fopen($app_script_file, 'w') or die('Cannot open file:  '.$app_script_file);
        		fwrite($handy, $SCRIPTAPPbody);
        		fclose($handy);
    ...
    function createFooter($i=0){
		...
		$html.= '<div data-role="footer" class="footerpartmain" style="position:fixed;bottom:0;">';
		    ...
		    $html.= '<div data-role="panel" id="left-panel" style="width:100%;" data-theme="d">'
            ...
            $html.= '<div data-role="panel" id="right-panel" data-display="push" data-position="right" data-theme="d">'
                    ...
                    '</div>';
 	    }elseif ($appOtherInfo['eBtnLayout'] == 'Top'){
			$html.= '<div data-role="footer" class="footerpartmain" style="position:fixed;top:0;">';
				$html.= '<div id="demo">
							<div id="owl-demo" style="width:100%;" class="owl-carousel myowl">'
								.$this->createFooterMenuTop($i).
							'</div> 
						</div>
					 </div>';
		}
	...
	function createFooterMenuTop($i)
	{
        $activeTabs = $this->data['appdata']['activeTabs'];
        $appOtherInfo = $this->data['appdata']['appOtherInfo'];
    ...
    function getMiddleContent($i)
	{
        ...
        switch($pageTypes){
            case "home":
                ...
                */
				    $html.= '<div data-role="fieldcontain" class="wrapmain" style="background:url('.$back_bg_image.')">';

                        $html.= '<h2 align="center">';
                            $html.= '<span> Details</span>';
                        $html.= '</h2>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="vName"><b>Website</b> :</label>';
                            $html.= ''.$homeinfo['vWebsite'].'';
                        $html.= '</div>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="vEmail"><b>Email</b> :</label>';
                            $html.= ''.$homeinfo['vEmail'].'';
                        $html.= '</div>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="vContactNumber"><b>Telephone</b> :</label>';
                            $html.= ''.$homeinfo['vTelephone'].'';
                        $html.= '</div>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="tMessage"><b>Address</b> :</label>';
                            $html.= ''.$homeinfo['vAddress1'].'<br />'.$homeinfo['vAddress2'].'';
                        $html.= '</div>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="tMessage"><b>City</b> :</label>';
                            $html.= ''.$homeinfo['vCity'].'';
                        $html.= '</div>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="tMessage"><b>State</b> :</label>';
                            $html.= ''.$homeinfo['vState'].'';
                        $html.= '</div>';
                        $html.= '<div data-role="fieldcontain">';
                            $html.= '<label for="tMessage"><b>Zip</b> :</label>';
                            $html.= ''.$homeinfo['vZip'].'';
                        $html.= '</div>';
					...
					foreach($opening_time_details as $val)
                    {
                        $html.= '<div data-role="fieldcontain" class="wrapmain" style="background:url('.$back_bg_image.')">';
                            $html.= '<div data-role="fieldcontain">';
                                $html.= '<label for="tMessage"><b>Day</b> :</label>';
                                $html.= ''.$val['vDay'].'';
                            $html.= '</div>';
                             $html.= '<div data-role="fieldcontain">';
                                $html.= '<label for="tMessage"><b>Open from</b> :</label>';
                                $html.= ''.$val['vOpenfrom'].'';
                            $html.= '</div>';
                             $html.= '<div data-role="fieldcontain">';
                                $html.= '<label for="tMessage"><b>Open to</b> :</label>';
                                $html.= ''.$val['vOpento'].'';
                            $html.= '</div>';
                        $html.= '</div>'."\n";  
                    }
		...
		case "Custom":
                $iApplicationId = $this->data['iApplicationId'];
                $custominfo = $this->preview_model->gettabwisecustom($iApplicationId, $iActiveId);
			    
				
				/* 
                	Description :- custom tab design
				*/
				$html.= '<div data-role="fieldcontain" class="wrapmain">';
						$html.= print_r($custominfo);
				$html.= '</div>'."\n"; 
			   break; 
        ...
        case "payment":
            ...
            case "form":
                    ...
                    $html.= '<div data-role="fieldcontain" class="wrapmain">';
                        ...
                        $html.= '</h2>';
                         $html .='<div id="mailing_validation" style="display:none;"><div style="color: #b94a48;background-color: #f2dede;border-color: #eed3d7; text-align:center;" id="msg"></div></div>';
             ...
             case "formC":
                  ...
                  /*$categoty = $this->preview_model->gettabwisecategory($iApplicationId, $iActiveId);*/
                    ...
                    $html.= '<div data-role="fieldcontain" class="wrapmain">';
                        ...
                        $html.= '</h2>';
                        $html .='<div id="contactus_validation" style="display:none;"><div style="color: #b94a48;background-color: #f2dede;border-color: #eed3d7; text-align:center;" id="msgcontact"></div></div>';
            ...
            case "list":
                    ...
                    elseif($tabTYpe == 'Menu')
                    {
                        ...
                        if($allmenudata){
                            ...
                            for($j=0;$j<count($allmenudata);$j++){
                                ...
                                if($j%2 == 0){                                    
                                    $html.= '<li class="list-odd-bg">
												 <a class="" href="" onclick="menuwiseitemlistdetail('.$iMenuID.',\''.$type.'\',\''.$allmenudata[$j]['vName'].'\');">
					...
					elseif($tabTYpe == 'Order')
					{
						...
						if($allorderdata)
                        {
                            ...
                            for($j=0;$j<count($allorderdata);$j++)
							{
								...
								$vOddRowBar = $appInfo['vOddRowBar'];
                                if($j%2 == 0){                                    
                                	$html.= '<li class="list-odd-bg">
                                             <a class="" href="" onclick="menuwiseitemlist('.$iMenuID.',\''.$type.'\',\''.$pageID.'\',\''.$vOddRowBar.'\',\''.$allorderdata[$j]['vName'].'\');">
                    ...
                    }elseif($tabTYpe == 'Reservation')
					{
                        ...
                        $this->load->model('reservation_tab_model');
                        $service_data = $this->reservation_tab_model->get_user_services('1');
						...
						foreach($service_data as $key => $val){
                            ...
                            $val['vAddress1'];
                            $val['vTime'];
                            if(strtotime($curr_date) > strtotime($val['vDate'])){
                                //date("l jS \of F Y h:i:s A");
                                $pserv.='<li><h6>'.date("l jS \of F Y", strtotime($val['vDate'])).'</h6>'.$val['vServiceName'].'<br /><label>'.$val['vAddress1'].'</label><br /> at <label>'.$val['vTime'].'</label> </li>';
                            }else{
                                $userv.='<li><h6>'.date("l jS \of F Y", strtotime($val['vDate'])).'</h6>'.$val['vServiceName'].'<br /><label>'.$val['vAddress1'].'</label><br /> at <label>'.$val['vTime'].'</label> </li>';
                            }
                        }
                        ...
                        $html.='<div data-role="tabs" id="tabs">
                                  <div data-role="navbar">
                                    <ul>
                                      <li><a href="javascript:show_res_tabs(\'one\',\'two\')" id="one_btn" data-ajax="false">Past Events</a></li>
                                      <li><a href="javascript:show_res_tabs(\'two\',\'one\')" id="two_btn" data-ajax="false">Upcoming</a></li>
                                    </ul>
                                  </div>
                                  
                                  <div id="one" class="ui-body-d ui-content" style="display:none;">
                                    <ul data-role="listview" data-inset="true">
                                        '.$pserv.'
                                    </ul>
                                  </div>
                                  <div id="two" class="ui-body-d ui-content" style="display:none;">
                                    <ul data-role="listview" data-inset="true">
                                        '.$userv.'
                                    </ul>
                                  </div>
                   ...
                   //     $html.= '<div id="book_service" style="display:none;"><input type="text" class="date-input-inline" data-inline="true" data-role="date" style="display:none;"></div>';
                        ...
                        if($allqrcodedata){
                            ...
                            for($j=0;$j<count($allqrcodedata);$j++){
                                ...
                                if($j%2 == 0){                                    
                                	...
                                	$html.= '<li class="list-even-bg" onclick="qrcodemakedetail(\''.$iQrText.'\');">
                                            <a class="" href="">
                        ...
                        if($allloyaltydata)
						{
                            ...
                            for($j=0;$j<count($allloyaltydata);$j++)
                            {
								...
								{                                    
                                    ...
                                    $html.= '<li class="list-even-bg" onclick="loyaltysettingsdetail();">
										<a class="" href="">
                            ...
                            $html.= '<div class="no_data">No Loyalty Avilable.</div>';  
                        }
                    }
                    ...
                    elseif($tabTYpe == 'Around Us'){
                            ...
                            // list view
                            $html .= '<li class="list-even-bg listviewaroundus listview" style="width:50%;float:left;"><a href="">';
                            $html .= 'List View';
                            $html .= '</a></li>';
							
                            // map view
                            $html .= '<li class="list-odd-bg maparoundus mapview" style="width:50%;float:left;"><a href="">';
                            $html .= 'Map View';
                            $html .= '</a></li>';       
                            ...
                            foreach($allaroundusdata as $val)
                            {
                                ...
                                $html .='<p class=" white_info "><b>Name</b> :&nbsp;'.$val['rName'].'</p>';
                                // $html .='Address :'.$val['rAddress1'].'<br/>';
                                $html .='<p class=" white_info "><b>City</b> :&nbsp;'.$val['rCity'].'</p>';
                                if($val['rDistanceType'] == 'mile'){
                                    $html .='<p class=" white_info "><b>Distance</b> :&nbsp;'.number_format($miles,2).'mile'. '</p>';
                                }else if($val['rDistanceType'] == 'km'){
                                    $html .='<p class=" white_info "><b>Distance</b> :&nbsp;'.number_format($miles * 1.609344,2).'&nbsp;'.'km'.'</p>';
                                }
                                $html .=' </a></li>';
                        ...
                        $html.= '<div>';
                            $html.= '<ul>';
                                foreach($videolisting_data as $key=>$videodata){
                                    ...
                                    {	
                                        $html.= '<li data-role="list-divider" role="heading" class="sectionheader"> Video </li>';
                                    }
            ...
            case "content":
                ...
                $infotabdata = $this->data['appdata']['infotabdata'][$iActiveId];
                   ...
                   $html.= '<div class="detail_part" style="background:url('.$back_bg_image.')">';
    ...
    function getgooglenews($keyword){
        ...
        $url = "http://ajax.googleapis.com/ajax/services/search/news?"."v=1.0&q=".$keyword."&userip=www.easyapps.fr&rsz=8";
