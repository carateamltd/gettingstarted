...
//Default Design Entry Save
			...
			$iAppDesignInfoId = $this->app_model->save('slb_app_design_ifo',$allappdesignInfo_default);
    ...
    function step4(){	
        ...
        //echo '<pre>';print_r($allappdesignInfo);exit;
	   ...
	   //Set Slider Image
		...
		if($sliderdata){
			...
			if($exist_info){
				...
				$this->app_model->save('slb_app_slider_img_value',$sliderdata);
				echo 'save';exit;
			}
		}
...
//echo '<pre>';print_r($this->data['newdesign_templates']);exit;
	...
	function step6()
	{
		...
		//echo "<pre>";print_r($this->data['paymentinfo']);exit;
...
/*        echo "<pre>";
    ...
    function geteventhtml($iFeatureId,$iAppTabId){
        $all_featurefields = $this->app_model->get_featurefields($iFeatureId);
            ...
            $html .='<div id="eventformid'.$iAppTabId.'" class="main_popup" style="display:none;">
                    ...
                    $html .='<div class="widget-body form">';
                        ...
                        $html .='<div class="row_form">
                        			<button type="button" class="btn btn-primary"  id="eventbtn" name="eventbtn" onclick="return submitevent('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i> Save</button>
                        		</div>';
            $html .='</div>
     	...
     	$html .='<div class="add_btn"><a class="btn btn-primary"  href="#eventformid'.$iAppTabId.'" id="addevenitid"  style="float:right;" onclick="open_ckeditor('.$iAppTabId.');">Add New Event</a></div>';
        ...
        $html .='<div id="event_listing'.$iAppTabId.'">
                    ...
                    if(count($allappevents) > 0){
                        ...
                        $html .='<tr class="row1a">
                                     ...
                                     <td align="center" width="13%"><a class="button grey" onclick="delete_event('.$allappevents[$i]["iEventId"].','.$iAppTabId.');" style="cursor:pointer;"><i class="icon-trash helper-font-24" title="Delete"></i></a></td>
                                </tr>';    
                        }    
                    }else{
                                    ...
                                    foreach ($all_featurefields as $val){		  		 
                                        ...
                                        case 'Date':
                                        	$html .='<div class="control-group">
                                                <label class="control-label">'.$val['vLabelName'].'</label>
                                                <div class="controls">
                                                    <input class="input-xlarge eventd" value="'.$eventinfo[$val['vDataBaseFieldName']].'" id="'.$val['vDataBaseFieldName'].'e'.$iAppTabId.'" name="data['.$val['vDataBaseFieldName'].']" type="text" >
                                                </div>
                                            </div>';
                                            break;
                                         case 'Time Textbox':
                        ...
                        <div class="lean-body">
                            <div class="widget-body form" >';
                                ...
                                $html .='<div class="row_form">
                                    ...
                                    <button type="button" class="btn btn-primary"   id="locationbtn" name="locationbtn" onclick="news_validation('.$iAppTabId.');"><i class="icon-ok"></i> Save</button>
                                </div>';
    ...
    function getmailinglisthtml($iFeatureId,$iAppTabId){
		...
		$html .='<div class="add_btn" style="width:50%;margin-top:-7%;"><a class="btn btn-primary"  href="#mailcat_listing'.$iAppTabId.'" id="mailingcategory"  style="float:left;">Edit Category</a></div>';
        ...
        $html .='<form name="frmmailinglist" id="frmmailinglist_'.$iAppTabId.'" method="post" action="'.$this->data['base_url'].'app/save_mailinglist" class="form-horizontal">
                                        ...
                                        case 'Checkbox':
                                         ...
                                         case 'Textarea':
                                        	$html .='<div class="control-group">
                                                        <label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <textarea class="input-xlarge"  name="data['.$val['vDataBaseFieldName'].']" id="'.$val['vDataBaseFieldName'].'e'.$iAppTabId.'" cols="" rows="">'.$appwise_mailinglist[$val['vDataBaseFieldName']].'</textarea>
                                                        </div>
                                                    </div>';					
                                                break;		
                ...
                </form></div><div class="span3"><div class="row_"><a href="#mailchampformid'.$iAppTabId.'" id="mailchamppopup"><img src="'.$this->data["base_url"].'assets/images/mc.png" width="150px" style="cursor:pointer;" ></a></div></div>
                ';
       ...
       // $all_featurefields = $this->app_model->get_featurefields($iFeatureId);
        #echo '<pre>';print_r($appwise_mailinglist);exit;
            ...
            $html .='<div id="mailchampformid'.$iAppTabId.'" class="main_popup" style="display:none;">
                    ...
                    <div class="popup-body">';        
                    $html .='<div id="addmailchamp_validation'.$iAppTabId.'" style="display:none;"></div>';
                    $html .='<div class="widget-body form">';
...
//echo $iApplicationId;exit;
  		...
  		$html .='<div class="main_popup" style="display:none;" id="mailcat_listing'.$iAppTabId.'"><div class="popup_header"><h3>Edit Category</h3></div>';
        ...
        $html .='<br><div class="category_tbl">
                    ...
                    if(count($allmailingcategories) > 0){
                        ...
                        $html .='<tr class="row1a">
                                     ...
                                     <td align="center" width="12%"><a class="apptab_edit"  onclick="edit_mailingcat('.$allmailingcategories[$i]["iMailcategoryId"].','.$iFeatureId.');"><i class="icon-pencil helper-font-24" title="Edit"></i></a></td>
...
//echo $iApplicationId;exit;
        ...
        if($this->input->post()){
          ...
          //  echo '<pre>';print_r($mailingcategory);exit;
            if($mailingcategory['iMailcategoryId']){
            	...
            	//echo 'eif';exit;
                $iMailinglistId = $this->app_model->save('slb_app_mailing_category',$mailingcategory);
               if($iMailinglistId){
                    redirect($this->data['base_url'] . 'app/step3/'.$mailinglist['iApplicationId']);
                }    
            }
    ...
    function getaddmailingcategoryhtml($iAppTabId,$iFeatureId){
		...
		$html .= '<div class="lean-body">
                        <div class="widget-body form" >
                        	<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="input-xlarge" value="" id="vName'.$iAppTabId.'" name="data[vName]" >
                                </div>
                            </div>
                        </div>
                    </div>'   ;                 
		$html .='</form> 
				<div class="popup-footer">
	                ...
	                <button type="button" aria-hidden="true" onclick="closeleanmodal();" class="btn">Close</button>
				</div>
				</div>';
    ...
    function showeditmailcatpopup(){
    	...
    	//echo '<pre>';print_r($iMailcategoryId);exit;
		...
		$html .= '<div class="lean-body">
                        <div class="widget-body form" >
                        	<div class="control-group">
                                <label class="control-label">Name</label>
                                <div class="controls">
                                    <input type="text" class="input-xlarge" value="'.$exist_info['vName'].'" id="vNamee'.$iAppTabId.'" name="data[vName]" >
                                </div>
                            </div>
        ...
        $html .='<form name="frmrss" id="frmrss_'.$iAppTabId.'" method="post" action="'.$this->data['base_url'].'app/save_rss" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="lean-body">
                        <div class="widget-body form" >';
                            ...
                            $html .='<div class="row_form">
                                <label class="checklabel">&nbsp;</label>
                                <button type="button" class="btn btn-primary"  id="locationbtn" name="locationbtn" onclick="rss_validation('.$iAppTabId.');"><i class="icon-ok"></i> Save</button>
                            </div>';
                                    ...
                                    foreach ($all_featurefields as $val){		  		 
                                        ...
                                        case 'File':
                                               $html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" style="display:none;">
                                                        <label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <input type="file"  value="" class="default" id="'.$val['vDataBaseFieldName'].$iAppTabId.'" name="'.$val['vDataBaseFieldName'].'" onchange="CheckValidPdfFile(this.value,this.name)">
                                                        </div>
                                                    </div>';					
                                                break;
                                        case 'Textarea':
                                        ...
                                        case 'Date':
                                         ...
                                         case 'Status':
                                        	$html .='<div class="control-group">
                                                        <label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <select name="data['.$val['vDataBaseFieldName'].']" id="'.$val['vDataBaseFieldName'].$iAppTabId.'" onchange="return showhide_file(this.value);">
                                        ...
                                        case 'File':
                                        		if($pdfinfo['eFileType'] == 'Pdf File'){
													...
													$html .='<div class="control-group" id="emaindiv'.$val['vDataBaseFieldName'].'" style="display:none;">';
                                                        ...
                                                        $html .='<label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <input type="file" class="default" id="'.$val['vDataBaseFieldName'].'e'.$iAppTabId.'" name="'.$val['vDataBaseFieldName'].'" style="float: left;"  onchange="CheckValidPdfFile(this.value,this.name)">';
                                        ...
                                        case 'Date':
                                         ...
                                         case 'Status':
                                        	$html .='<div class="control-group" >
                                                        <label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <select name="data['.$val['vDataBaseFieldName'].']" id="'.$val['vDataBaseFieldName'].'e'.$iAppTabId.'" onchange="return showhide_fileedit(this.value);">';
        ...
        $all_featurefields = $this->app_model->get_featurefields($iFeatureId);
            ...
            $html .='<div id="locationformid'.$iAppTabId.'" class="main_popup" style="display:none;">
                    ...
                    $html .='<div class="widget-body form">';
                                    ...
                                    foreach ($all_featurefields as $val){		  		 
                                                       ...
                                                       $html .= '<label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">';
															if($val['vDataBaseFieldName'] == 'vCity' || $val['vDataBaseFieldName'] == 'vState'){
                                                            	...
                                                            	$html .='<input type="text" value="'.$locinfo[$val['vDataBaseFieldName']].'" class="input-xlarge" id="'.$val['vDataBaseFieldName'].''.$iAppTabId.'" name="data['.$val['vDataBaseFieldName'].']" >';
															}
                                                        $html .= '</div>';
                                                    	if($val['vDataBaseFieldName'] == 'vWebsite'){
	                                                        $html .='<div class="controls">
	                                                        	<span style="color:red;">(Note: Please put website url <br>Ex :http://www.youtube.com)</span>
	                                                        </div>';
                                                    	}
                                        ...
                                        case 'Checkbox':
                                            $html .='<div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <label class="checkbox">
                                                                <input type="checkbox" value=""  id="'.$val['vDataBaseFieldName'].$iAppTabId.'" name="data['.$val['vDataBaseFieldName'].']">
                                                            </label>
                                                        </div>
                                                    </div>';
                                             break;
                        ...
                        $html .='</div>';
                        $html .='<div class="row_form">
                        			<button type="button" class="btn btn-primary"  id="eventbtn" name="eventbtn" onclick="return submitlocation('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i> Save</button>
                        		</div>';
            $html .='</div>
            <div class="popup-footer">
                <button aria-hidden="true" onclick="closeleanmodal();" class="btn">Close</button>
     	...
     	$html .='<div class="add_btn"><a class="btn btn-primary"  href="#locationformid'.$iAppTabId.'" id="addpdfid"  style="float:right;">Add New Location</a></div>';
           ...
           #  print_r($all_featurefields[1]['vDataBaseFieldName']);exit;
            $html .='<div id="locformid" class="main_popup" style="display:block;">
                    ...
                    $html .='<div class="widget-body form">';
                        ...
                        $html .='</div>';
                        $html .='<div class="row_form">
                        			<button type="button" class="btn btn-primary"  id="locbtn" name="locbtn" onclick="return updateloc('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i> Save</button>
                        		</div>';
            $html .='</div>
            <div class="popup-footer">
                <button aria-hidden="true" onclick="closeleanmodal();" class="btn">Close</button>
...
//Webiste Start
    ...
    function get_all_website_data($iApplicationId,$iAppTabId,$iFeatureId){
      ...
      #   echo '<pre>';print_r($allappwebsites);exit;
        $html .='<div id="website_listing'.$iAppTabId.'">
                    <table width="100%" cellspacing="0" cellpadding="0" class="table table-striped table-hover table-bordered" id="sub_tab_listing">
                    <tr class="nodrop">
                        <th>Thumbnil</th>
                        <th>Name</th>
                    ...
                    if(count($allappwebsites) > 0){
                        ...
                        $html .='<tr class="row1a">';
                                     ...
                                     $html .='<td align="center" width="12%"><a class="apptab_edit"  onclick="edit_website('.$allappwebsites[$i]["iWebsiteId"].','.$iFeatureId.');"><i class="icon-pencil helper-font-24" title="Edit"></i></a></td>
                                     <td align="center" width="13%"><a class="button grey" onclick="delete_website('.$allappwebsites[$i]["iWebsiteId"].','.$iAppTabId.');" style="cursor:pointer;"><i class="icon-trash helper-font-24" title="Delete"></i></a></td>
                                </tr>';    
                        }    
                    }else{
                                    ...
                                    foreach ($all_featurefields as $val){		  		 
                                        ...
                                        case 'Textxbox':
                                      				$html .='<div class="control-group" id="emaindiv'.$val['vDataBaseFieldName'].'">';
                                                         $html .='<label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <input type="text" value="'.$websiteinfo[$val['vDataBaseFieldName']].'" class="input-xlarge" id="'.$val['vDataBaseFieldName'].'e'.$iAppTabId.'" name="data['.$val['vDataBaseFieldName'].']" >
                                                        </div>
                                                    </div>';
                                                break;
                                        case 'Checkbox':
        ...
        if($this->input->post()){
          ...
          # echo '<pre>';print_r($podcast);exit;
            if($podcast['iPodcastId']){
                ...
                $iPodcastId = $this->app_model->save('slb_app_podcast_values',$podcast);
...
function save_slider_img_by_app(){
	...
	if($exist_info){
		...
		$this->app_model->save('slb_app_slider_img_value',$data);
		echo 'save';exit;
	}
...
function assign_temp(){
	...
	unset($defaultappdesignInfo['eStatus']);
	 ...
	 if($checkappdesign_info){
		...
		$iAppDesignInfoId = $this->app_model->save('slb_app_design_ifo',$defaultappdesignInfo);
	}
...
function getnotepadhtml($iFeatureId,$iAppTabId){
	$html .= '<link rel="stylesheet" href="'.$this->data["base_assets"].'notepad/notpad_app.css" type="text/css" />
				...
				<script src="'.$this->data["base_assets"].'/notepad/notpad_notes.js" cache="false"></script>';
	;
...
function save_feepayment(){
	...
	if($payment){
		...
		//$iAppFeeTypeId = $this->app_model->save('slb_app_feetype_value',$payment);
		//if($iAppFeeTypeId){
			foreach ($selected_feedstails as $key => $value) {
				...
				$iAppFeeTypeId 	 = $this->app_model->save('slb_app_feetype_value',$slb_app_fee_payment_detail);
			}
		//}
	}
...
function gethometabhtml($iFeatureId,$iAppTabId){
        ...
        $html .='<form name="frmhometab" id="frmhometab_'.$iAppTabId.'" method="post" action="'.$this->data['base_url'].'app/save_hometabdata" class="form-horizontal">
                    <input class="span6" type="hidden" name="data[iApplicationId]" value="'.$this->data['iApplicationId'].'">
                    <input class="span6" type="hidden" name="data[iAppTabId]" value="'.$iAppTabId.'">
                    ...
                    <div class="lean-body">
                        <div class="widget-body form" >';
                            ...
                            foreach ($all_featurefields as $val){		  		 
                                        ...
                                        case 'Editor':
                                        	$html .='<div class="control-group">
                                                        <label class="control-label">'.$val['vLabelName'].'</label>
                                                        <div class="controls">
                                                            <textarea class="input-xlarge ckeditor" rows="3" name="data['.$val['vDataBaseFieldName'].']" id="'.$val['vDataBaseFieldName'].$iAppTabId.'" >'.$appwise_hometabdata[$val['vDataBaseFieldName']].'</textarea>
                                                        </div>
                                                    </div>';					
                                                break;
                                        }
                            ...
                            $html .='<div class="row_form">
                                <label class="checklabel">&nbsp;</label>
                                <button type="button" class="btn btn-primary"  id="homebtn" name="homebtn" onclick="hometab_validation('.$iAppTabId.');"><i class="icon-ok"></i> Save</button>
                            </div>';
...
function save_hometabdata(){
    ...
    if($this->input->post()){
        if($data['iHometabId']){
			...
			$iHometabId = $this->app_model->update_home($data,$iHometabId);
