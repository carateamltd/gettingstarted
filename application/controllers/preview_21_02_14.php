...
class Preview extends MY_Controller
{
    ...
    function index()
    {
        ...
        if($appInfo['vLuncherTintColor'] !=''){
            $CSSbody = str_replace("##LUNCH_TEXT_COLOR##",$appInfo['vLuncherTintColor'],$CSSbody);
        }else{
            $CSSbody = str_replace("##LUNCH_TEXT_COLOR##",'#FFFFFF',$CSSbody);
        }
        ...
        $html_last.= '<div data-role="page" id="map_direction">';
         ...
         if($this->data['appdata']['appOtherInfo'][0]['eTellFriendBtn'] == 'Yes'){
            ...
            $SCRIPTbody .= 'var myLatlng = new google.maps.LatLng(lat,lon);'."\n";
                ...
                // $SCRIPTbody .= 'var client_lat = "43.465187";'."\n";
                // $SCRIPTbody .= 'var client_lang = "-80.522372";'."\n";
    ...
    function getMiddleContent($i){
        ...
        switch($pageTypes){
            ...
            case "notepad":
                ...
                $html.= '<iframe class="" type="text/html" width="100%" height="476.5" src="notes.html" frameborder="0"> </iframe>';
                break;
