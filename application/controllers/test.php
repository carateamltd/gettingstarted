<?php
		...
		function __construct() 
	{
		...
		/** gateway details **/
		$gateway->apiUsername = "mayur.intelithub-facilitator-1_api1.gmail.com";
		$gateway->apiPassword = "ESA6QXH3KJ4DH95M";
		$gateway->apiSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31ArExYDECbZ5G3u-4ebpvRW1zBCky";
		$gateway->testMode = true;
		$gateway->returnUrl = "http://admin.easy-apps.co.uk/test/paypal_success";
		$gateway->cancelUrl = "http://admin.easy-apps.co.uk/test/paypal_cancel";
	...
	**/
	...
	public function paypal_success()
	{
		...
		/** resultData **/
	 	$resultData = array();
		$isOk = $recurring->obtainBillingAgreement("EasyApps", "mayur@hiveinfotech.com", 'USD', $resultData);
