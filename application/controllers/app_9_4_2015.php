...
//Default Design Entry Save
	...
	function showeditservicepopup()
	{
		...
		$html .='<div id="serviceformid'.$iAppTabId.'" class="main_popup">
				...
				$html .='<br />';
                    		$html .='<div class="control-group">
			                 <div class="controls">
						<button type="button" class="btn btn-primary"  id="servicebtn" name="servicebtn" onclick="return updateservice('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i> Save</button>
	                         	</div>
		                    </div>';
                            $html .='</form>';
                       $html .='</div>';
		...
		$html .= '<div class="popup-footer">
			<button aria-hidden="true" onclick="closeleanmodal('."'frmservice_$iAppTabId'".');" class="btn">Close</button>
				</div>
			</div>';
	...
	{
		$lang= $this->session->userdata('language');
		$promotion_language = $this->admin_model->get_language_details($lang);
		...
		$html .='<div id="promotionformid'.$iAppTabId.'" class="main_popup" style="display:none;">
		            <div class="popup_header">
		                <h3>';
				foreach($promotion_language as $val1){
					if($val1['rLabelName'] == 'Add New Promotion'){
						$html.=$val1['rField'];
					}
				}
				$html.='</h3>
				...
				$html .='<div class="control-group">
			                        <label class="control-label">';
						foreach($promotion_language as $val1){
							if($val1['rLabelName'] == 'Promotion Title'){
								$html.=$val1['rField'];
							}
						}
						$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Promotion Title </span></a></label>
			                        <div class="controls">
				...
				$html .='<div class="control-group">
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;(200px * 200px) </span></a></label>
                                        <div class="controls">
					   ...
					   $html.='<img id="vImage" src="'.$this->data['base_url'].'uploads/Item/noimg.png" width="200" height="200"/>
                            	...
                            	$html .='<div class="control-group">
                                        <label class="control-label">';
					foreach($promotion_language as $val1){
						if($val1['rLabelName'] == 'Promotion Description'){
							$html.=$val1['rField'];
						}
					}
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Promotion Description </span></a></label>
                                        <div class="controls">
                                            <textarea class="input-xlarge" value="" rows="3" name="data[tDescription]" id="tDescription'.$iAppTabId.'"></textarea>
                                        </div>
                                    </div>';
				...
				$html .='<div class="control-group">';
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Start Date </span></a></label>
                                        <div class="controls">
				...
				$html .='<div class="control-group">';
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;End Date </span></a></label>
                                        <div class="controls">
						<div class="input-append bootstrap-datepicker">
				...
				$html .='<br />';
                    		...
                    		$html .='<div class="control-group">
			                 <div class="controls">
						<button type="button" class="btn btn-primary"  id="promotionbtn" name="promotionbtn" onclick="return submitpromotiondetails('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i>';
					foreach($promotion_language as $val1){
		...
		$html.='<style>#dyntable input{width:auto !important;}</style>';
			$html.='<div class="add_btn"><a class="btn btn-primary"  href="#promotionformid'.$iAppTabId.'" id="addpromotionid"  style="float:right;" onclick="open_ckeditor('.$iAppTabId.');">';
			foreach($promotion_language as $val1){
				if($val1['rLabelName'] == 'Add Promotion'){
					$html.=$val1['rField'];
				}
			}
		$html.='</a></div>';
	...
	function showeditpromotionpopup()
	{
		...
		$html .='<div id="promotionformid'.$iAppTabId.'" class="main_popup">
		            <div class="popup_header">
		                <h3>';
				foreach($promotion_language as $val1){
					if($val1['rLabelName'] == 'Edit Promotion'){
						$html.=$val1['rField'];
					}
				}
				$html.='</h3>
		    ...
		    <div class="popup-body">';        
				...
				$html .= '<input class="span6" type="hidden" name="data[iPromotionsId]" value="'.$iPromotionsId.'">';
						...
						$html .= '<label class="control-label" style="cursor:default;">';
						foreach($promotion_language as $val1){
							if($val1['rLabelName'] == 'Promotions Title'){
								$html.=$val1['rField'];
							}
						}
						$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Promotion Title </span></a></label>
					...
					$html .='<div class="control-group">
                                                <label class="control-label">';
						foreach($promotion_language as $val1){
							if($val1['rLabelName'] == 'Promotions Description'){
								$html.=$val1['rField'];
							}
						}
						$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Promotion Description </span></a></label>
					...
					$html .='<br />';   
				    	...
				    	$html .='<div class="control-group">
					         <div class="controls">
							<button type="button" class="btn btn-primary"  id="promotionbtn" name="promotionbtn" onclick="return submitpromotionsdetails('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i>';
						foreach($promotion_language as $val1){
							if($val1['rLabelName'] == 'Save'){
								$html.=$val1['rField'];
							}
	...
	function getnewarrivaltabhtml($iFeatureId,$iAppTabId)
	{
			...
			$html.='</h3>
			    ...
			    $html .= '<input type="hidden" name="language" id="language" value="'.$lang.'" />';
                            ...
                            $html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'">';
                                       $html .= '<label class="control-label" style="cursor:default;">';
				       foreach($arrival_language as $val1){
						if($val1['rLabelName'] == 'Arrival Types'){
							$html.=$val1['rField'];
						}
					}	
				       $html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Arrival Type </span></a></label>
		<div class="controls">
		...
		$html.='</select>	
				...
				$html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" >
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Arrival Name </span></a></label>
                                         <div class="controls">
				...
				$html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" >
					...
					foreach($arrival_language as $val1){
						...
						$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Arrival Offer </span></a></label>
                                         <div class="controls">
				...
				$html .='<div class="control-group">
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Arrival Description </span></a></label>
                                         <div class="controls">
	...
	function showeditcataloguepopup()
	{
		...
		$html .='<div id="catalogueformid'.$iAppTabId.'" class="main_popup">
				...
				foreach($location_language as $val1){
					if($val1['rLabelName'] == 'Edit Catalogue'){
						$html.=$val1['rField'];
					}
				}
				$html.='</h3>
			...
			$html .= '<input class="span6" type="hidden" name="iCatalogueId" value="'.$iCatalogueId.'">';
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Select Catalogue Types</span></a></label>
		                        <div class="controls">
				...
				$html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" >
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Catalogue Name </span></a></label>
                                        <div class="controls">
				...
				$html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" >
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Catalogue Description </span></a></label>
                                        <div class="controls">
				...
				$html .='<div class="control-group">
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Total Number of Available Product </span></a></label>
                                        <div class="controls">
				...
				$html .='<div class="control-group">
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Currency Code </span></a></label>
                                        <div class="controls">
				...
				$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Different size of Catalogue </span></a></label>
			</div>';
...
//		$appindustry = $this->app_model->get_all_appindustry_clientId($iClientId,$iRoleId);
		...
		$html .='<div id="catalogueformid'.$iAppTabId.'" class="main_popup" style="display:none;">
			...
			$html.='</h3>
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Select Catalogue </span></a></label>
                                        <div class="controls">
					<select name="data[iCatalogueType]" id="iCatalogueType'.$iAppTabId.'">';
					$html.='<option value="'.$appindustry['iIndustryId'].'">'.$appindustry['vTitle'].'</option>';
					$html.='</select>	
				...
				$html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" >
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Catalogue TagName </span></a></label>
                                        <div class="controls">
				...
				$html .='<div class="control-group" id="maindiv'.$val['vDataBaseFieldName'].'" >
					...
					$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Total Number Of Product </span></a></label>
                                        <div class="controls">
       ...
       # print_r($pdfinfo);exit;
        ...
        $html .='<div id="loyaltyformid" class="main_popup" style="display:block;">
                    <div class="popup_header">
                        <h3>';
                        foreach($loyalty_language as $val){
							if($val['rLabelName'] == 'Edit Loaylty'){
								$html.=$val['rField'];
							}
						}
                        $html.='</h3>
...
/*                                        case 'Textxbox':
                        ...
                        $html .='</div>';
                        $html .='<div class="row_form">
                        			<button type="button" class="btn btn-primary"  id="eventbtn" name="eventbtn" onclick="updateqrcoupon('.$iAppTabId.','.$iFeatureId.');"><i class="icon-ok"></i> ';
													foreach($coupon_language as $val1){
														if($val1['rLabelName'] == "Save"){
															$html.=$val1['rField'];
														}
					...
					foreach($all_featurefields as $val){
							switch ($val['eType']){
								...
								<label class="control-label">';
									...
									$html.=' :<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Description  </span></a></label>
								<div class="controls">';
           ...
           <button onclick="deletehomefile('.$home_page_details[0]['iHometabId'].');" class="btn btn-primary delete" type="button">Delete</button></div>';
								...
								case 'Checkbox':
									...
									$html.=' onclick="getlatlangforhome('.$iAppTabId.');"> &nbsp; ';
											...
											$html.='<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Lattitude & Longitude </span></a>
												</div>
											</div>';
									break;
								...
								case 'SelectBox':
									$html.='<div class="control-group">
												<label class="control-label">';
													...
													$html.=' :<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> &nbsp;Distance Types </span></a></label>';
					...
					$html .='<div class="row_form">
								<label class="checklabel">&nbsp;</label>
								<button type="button" class="btn btn-primary save"  id="homebtn" name="homebtn" onclick="hometab_validation('.$iAppTabId.');"><i class="icon-ok">';
								foreach($home_language as $val1){
									if($val1['rLabelName'] == 'Save'){
										$html.=$val1['rField'];
									}
    ...
    function getgalleryhtml($iFeatureId,$iAppTabId){
        ...
        $html .='<form name="frmgallery" id="frmgallery_'.$iAppTabId.'" method="post" action="'.$this->data['base_url'].'app/save_gallery" class="form-horizontal" enctype="multipart/form-data">
					...
					foreach($gallery_language as $val){
									if($val['rLabelName'] ==$val['vLabelName']){
										$html.=$val['rField'];
									}
       							} $html .='</label>';
	...
	function getorderhtmldetail($iFeatureId,$iAppTabId)
	{
		...
		$html .='<div class="add_btn"><strong>';
				...
				$html.=' : </strong><a class="btn btn-primary"   href="#menuorderformid'.$iAppTabId.'" id="addpdfid"  style="float:right;">';
					foreach($order_language as $val1){
						if($val1['rLabelName'] == 'Manage Orders'){
							$html.=$val1['rField'];
						}
					}
					$html.='</a></div>';
				            ...
				            <div class="modal-body">
				                ...
				                <table>
									...
									<tr>
										...
										<td><input type="text" name="vPrice" id="vPrice" value="" style="width:50px;" /></td>
										<td><input type="text" name="vReservationFee" id="vReservationFee" value="" style="width:50px;" /></td>
										<td><input type="text" name="vMaxService" id="vMaxService" value="" style="width:50px;" /></td>
										<td><input type="text" name="iDuration" id="iDuration" value="" style="width:50px;" /></td>
									</tr>
								</table>
								<strong>';
										foreach($location_language as $val1){
				        ...
				        <div class="modal-content">
				            ...
				            <table>
								<tr>
									...
									$html.=	' :<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Mobile&nbsp;Service center Name </span></a> <br/>
									...
									$html.=	': <a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Mobile&nbsp;Description </span></a><br />
								...
								<tr>
									...
									$html.=	':<a class="tooltip_text" href="javascript:void(0);"><img src="http://www.admin.easy-apps.co.uk/assets/images/quaton_icon.png" align="absmiddle"> <span> <img class="callout_text" src="http://www.admin.easy-apps.co.uk/assets/images/callout.gif"> Mobile&nbsp;Admin Email </span></a> <br />
				            ...
				            <div class="modal-footer">
				                ...
				                <button type="button" class="btn btn-default" data-dismiss="modal">';
									...
									$html.=	'</button>
				                <button type="button" onclick="return update_gen_info();" class="btn btn-primary">';
									foreach($location_language as $val1){
										if($val1['rLabelName'] == "Save changes"){
											$html.=$val1['rField'];
										}
...
onclick="getlatlangforreservation('.$iAppTabId.');" /> ';
				            ...
				            <div class="modal-footer" id="modal-footer">
				                ...
				                <button type="button" class="btn btn-default" data-dismiss="modal">';
									...
									$html.=	'</button>
				                <button type="button" id="local_modal_id" onclick="return addlocation();" class="btn btn-primary">';
									foreach($location_language as $val1){
										if($val1['rLabelName'] == "Save changes"){
											$html.=$val1['rField'];
										}
