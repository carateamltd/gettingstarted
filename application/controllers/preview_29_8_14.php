            ...
            case "home":
                ...
                Description :- Home tab design*/
                 ...
                 /*  $html.= '<div class="detail_part">';
                        ...
                        $html.= '<center><p><h3>Details </b></h3></center>';
                        $html.= '<p>Website : '.$homeinfo['vWebsite'].'</p>';
                        $html.= '<p>Email : '.$homeinfo['vEmail'].'</p>';
                        $html.= '<p>Telephone : '.$homeinfo['vTelephone'].'</p>';
                        $html.= '<p>Address : '.$homeinfo['vAddress1'].'<br />'.$homeinfo['vAddress2'].'</p>';
                        $html.= '<p>City : '.$homeinfo['vCity'].'</p>';
                        $html.= '<p>State : '.$homeinfo['vState'].'</p>';
                        $html.= '<p>Zip : '.$homeinfo['vZip'].'</p>';
                        $html.= '</div>';
            ...
            case "list":
					...
					elseif($tabTYpe == 'Loyalty')
					{
					    ...
					    if($allloyaltydata){
							...
							{
                            //  $iMenuID = $allloyaltydata[$j]['iMenuID'];
                                if($j%2 == 0){                                    
                                    $html.= '<li class="list-odd-bg" style="background:#A9A9A9;">
                                             <a class="" href="" onclick="loyaltysettingsdetail('.$allloyaltydata[$j]['iLoyaltyID'].','.$allloyaltydata[$j]['vSquareCount'].');">
                                            <h2 class="hd_whitecolor">'.$allloyaltydata[$j]['vRewardText'].'</h2>
											<h2 class="hd_whitecolor">'.$allloyaltydata[$j]['vSquareCount'].'/'.'0'.'</h2>
                                            </a>
                                        </li>';
                                }else{
...
<<<<<<< .mine
                                            ...
                                            //echo "<pre>";print_r($photoset[$j]['photoset_images']);exit;
											for($m=0;$m<count($photoset[$j]['photoset_images']);$m++){
													if($vFlickerDisplay == 'Grid'){
															...
															//$galleryImageHtml.= '<div class="content-primary coverflow" style="margin-top: 50%;">';
																//$galleryImageHtml.= ' <ul>';
																//foreach($maingalimagearr as $key=>$val){
...
>>>>>>> .r26
						...
						elseif($eFlickerGalleryType == 'Phtostream')
						{
                            ...
                            if(count($photo_stream) > 0){
                                if($vFlickerDisplay == "Grid"){
                                    $html.= '<div class="content-primary">';
                                        $html.= ' <ul id="iGallery" class="gallery">';
                                                    foreach($photo_stream as $key=>$val){                                                        $html.= '<li class="gallery_photo"><a href="'.$val['org_url'].'"><img src="'.$val['org_url'].'" alt="" width="135" height="80"></a></li>';    
                                                    }
                                        $html.= '</ul>';
                                    $html.= '</div>';
                                }else{
                                    $html.= '<div class="content-primary coverflow" style="margin-top: 50%;">';
                                        $html.= ' <ul>';
                                                    foreach($photo_stream as $key=>$val){                                                    $html.= '<li ><div><img src="'.$val['org_url'].'" alt=""></div></li>';                                                    }
                                        $html.= '</ul>';
                                    $html.= '</div>';
                                }
				   ...
				   **/
				   else if($gallerydetail['eImageServiceType'] == 'Picasa')
				   {
						 ...
						 if($gallerydetail['vPicassaEmail'] !='' )
						 {
						 	/** picasa email **/
