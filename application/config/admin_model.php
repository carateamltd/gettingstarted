...
class admin_model extends CI_Model 
{
    ...
    {
        $this->db->select('a.iAdminId,a.vFirstName,a.vLastName,a.vEmail,a.iRoleId,a.eStatus,a.vPassword,a.vType,a.dDateTime');
    ...
    */
	...
	function sent_email_registration_form($data,$base)
	{
		...
		// More headers
		$headers .= 'From: Info@intelithub.com' . "\r\n";
