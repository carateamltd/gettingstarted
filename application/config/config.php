...
/*if($_SERVER["HTTP_HOST"] == '192.168.1.41')
{
	$sitefolder = "/php/slb/";
}else{
    $sitefolder = "/~techiest/php/slb/";
}*/
if($_SERVER["HTTP_HOST"] == '192.168.1.100')
{
	$sitefolder = "/erestaurant/";
}
elseif($_SERVER["HTTP_HOST"] == '122.170.107.160')
{
	$sitefolder = "/erestaurant/";
}elseif($_SERVER["HTTP_HOST"] == 'www.admin.easy-apps.co.uk')
{
	$sitefolder = "/";
}else if($_SERVER["HTTP_HOST"] == 'www.admin.easyapps.fr'){
	$sitefolder = "/";
}
else
{
...
//echo $config['base_download_path'];exit;
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
