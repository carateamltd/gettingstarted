Ext.define('MyApp.view.menu.OrderDetailView', {
    extend: 'Ext.List',
    xtype: 'orderdetailview1',
//    requires: ['MyApp.view.OrderView.ShowOrderView'],
    config: {
    	title: Loc.t('MENU.MENUDETAILS'),
...
<div style="font-weight:bold;font-size:14px; font-style:italic;padding:0px 0px 0px 10px;">'+Loc.t('MENU.PRICE')+': {fPrice} {vCurrency}</div>\n\
<div style="font-weight:bold;font-size:14px; font-style:italic;padding:0px 0px 0px 10px;">'+Loc.t('MENU.SIZE')+': {all_sizes} </div>\n\
<div style="font-weight:bold;font-size:14px; font-style:italic;padding:0px 0px 0px 10px;">'+Loc.t('MENU.OPTION')+': {all_options} </div>\n\
