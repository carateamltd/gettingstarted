    ...
    initialize: function () {
        var arround_ListView = new Ext.create('Ext.List', {
            ...
            itemTpl: new Ext.XTemplate('<table cellpadding="0" cellspacing="0" width="100%" style="background-color:rgba(255, 255, 255, 0.5); font-style:italic; border-radius:10px; margin:10px 0px;font-family:RalewayRegular;">\n\
				<tr>\n\
				<td valign="top">\n\
				<div style="font-weight:bold;font-size:14px; margin:0px; padding:5px 0 0 10px;">'+Loc.t('LOCATION.NAME')+': {vLocationTitle}</div>\n\
				<div style="font-weight:bold;font-size:14px; margin:0px; padding:0 0 0 10px;">'+Loc.t('LOCATION.ADDRESS')+': {vAddress1} \t {vAddress2}</div>\n\
				<div style="font-weight:bold;font-size:14px; margin:0px; padding:0 0 0 10px;">'+Loc.t('CATELOG.CITY')+': {vCity}</div>\n\
				<div style="font-weight:bold;font-size:14px; margin:0px; padding:0 0 5px 10px;">'+Loc.t('CATELOG.PIN')+': {vZip}</div>\n\
				</td></tr></table>'),
        });
