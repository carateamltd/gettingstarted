...
function addlocation(){
	...
	if(vZip == ''){
			$('#Reservationlocation_validation').html('<div class="alert alert-error"><button type="button" style="color: black !important;" class="close" data-dismiss="alert">&times;</button>Please enter zipcode.</div>');
			$('#Reservationlocation_validation').show();
			$('#vZip_res').focus();
			return false;
		}else{
	...
	if (vZip !='' && vZip.length > 6 || vZip.length < 6) {		
		$("#Reservationlocation_validation").html('<div class="alert alert-error"><button type="button" style="color: black !important;" class="close" data-dismiss="alert">&times;</button>Please enter six digit.</div>');
		$("#Reservationlocation_validation").show();
		$("#vZip_res").focus();
		return false;
    ...
    if (vTelephone=='') {		
		$("#Reservationlocation_validation").html('<div class="alert alert-error"><button type="button" style="color: black !important;" class="close" data-dismiss="alert">&times;</button>Please enter telephone.</div>');
		$("#Reservationlocation_validation").show();
		$("#vTelephone_res").focus();
		return false;
    ...
    if (vTelephone !='' && !IsPhone(vTelephone)) {		
		$("#Reservationlocation_validation").html('<div class="alert alert-error"><button type="button" style="color: black !important;" class="close" data-dismiss="alert">&times;</button>Please enter valid telephone.</div>');
		$("#Reservationlocation_validation").show();
		$("#vTelephone_res").focus();
		return false;
    ...
    if(vTelephone !='' && vTelephone.length > 11 || vTelephone.length < 11){
    	$("#Reservationlocation_validation").html('<div class="alert alert-error"><button type="button" style="color: black !important;" class="close" data-dismiss="alert">&times;</button>Please enter 11 Digit.</div>');
		$("#Reservationlocation_validation").show();
		$("#vTelephone_res").focus();
		return false;
    }else{
	...
	$.ajax({
		...
		type: "POST",
		data: {iApplicationId:''+iApplicationId+'',iTabId:''+iTabId+'',vAddress1:''+vAddress1+'',vAddress2:''+vAddress2+'',vCity:''+vCity+'',vState:''+vState+'',vZip:''+vZip+'',vWebsite:''+vWebsite+'',vEmail:''+vEmail+'',vTelephone:''+vTelephone+'',vLatitude:''+vLatitude+'',vLongitude:''+vLongitude+''},
		dataType:'json',
		success: function(response){
			...
			var row = table.insertRow(-1);
			var vAddress_tab = row.insertCell(0);
			var vAction = row.insertCell(1);
			var vAction1 = row.insertCell(2);
...
function updatelocation(iLocationId){
	...
	$.ajax({
		...
		type: "POST",
		data: {iLocationId:''+iLocationId+'',iApplicationId:''+iApplicationId+'',iTabId:''+iTabId+'',vAddress1:''+vAddress1+'',vAddress2:''+vAddress2+'',vCity:''+vCity+'',vState:''+vState+'',vZip:''+vZip+'',vWebsite:''+vWebsite+'',vEmail:''+vEmail+'',vTelephone:''+vTelephone+'',vLatitude:''+vLatitude+'',vLongitude:''+vLongitude+''},
		dataType:'json',
		success: function(response){
